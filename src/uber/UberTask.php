...
final class UberTask extends Phobject {
  ...
  public function __construct($console, $openUrisInBrowser, $jql = '', $url = self::URL) {
    $this->console = $console;
    $this->openUrisInBrowser = $openUrisInBrowser;
    $this->jql = $jql;
    $this->url = $url;
  }
  ...
  public function getJiraIssuesForAttachment() {
