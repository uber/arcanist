...
# You can cancel JIRA issue creating by exiting editor and not saving changes.
    ...
    while (true) {
      ...
      foreach ($result as $line) {
        ...
        if ($project) {
          ...
          $editor = new PhutilInteractiveEditor(sprintf($this->getTaskTemplate(), $summary, $description, $project));
